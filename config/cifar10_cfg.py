...
def get_config():
    ...
    config.data_dir = '/cluster/scratch/rarade/data/cifar10/'
    config.cc_dir = '/cluster/scratch/rarade/data/cifar10c/'
    ...
    # Model
    config.save_dir = '/cluster/scratch/rarade/common_corruptions/PRIME/c10_prime/'
